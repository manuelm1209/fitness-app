...
import 'package:fitmodeco_navbar/login_admin/login_page.dart';
  ...
  void initState() {
    ...
    slides.add(
      new Slide(
        ...
        description:
            "Crea tus propias recetas, compártelas con el mundo, o guárdalas para ti en tu recetario personal",
    ...
    slides.add(
      new Slide(
        ...
        styleTitle: TextStyle(
            ...
            fontFamily: 'RobotoMono'),
        description:
            "Sabemos que la alimentación es lo más importante para conseguir cualquier objetivo, por eso buscamos mejorar la App para que sea todo lo que necesitas",
        styleDescription: TextStyle(
            color: Colors.white,
            fontSize: 20.0,
            fontStyle: FontStyle.italic,
    ...
    slides.add(
      new Slide(
        ...
        styleTitle: TextStyle(
            ...
            fontFamily: 'RobotoMono'),
        description:
            "Todos los días aumenta el número de recetas y de nuevos suscriptores",
        styleDescription: TextStyle(
            color: Colors.white,
            fontSize: 20.0,
            fontStyle: FontStyle.italic,
